...
const Upload = ({area_code, store_name, product_name, product_detail, product_image, offer_detail, start_date, end_date}) => (dispatch, getState) => {
    const config = {
        headers: {
    ...
    API.post('api/offers', form_data, config)
    .then(res => {
